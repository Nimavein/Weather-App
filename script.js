...
async function getWeatherInfo() {
  try {
    const searchInputValue = await document.getElementById("search-input")
      .value;
    const fetchValue =
      await `http://api.openweathermap.org/data/2.5/weather?q=${searchInputValue}&appid=3f05cdb8836f854ec804cf8f7b03ef7c`;
